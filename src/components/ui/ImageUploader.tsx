...
const ImageUploader: React.FC<ImageUploaderProps> = ({ images, setImages, maxImages = 3 }) => {
  ...
  return (
    <div>
      ...
      <div
        className="border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center cursor-pointer hover:border-primary transition min-h-[120px] relative"
        onDrop={handleDrop}
